...
<!-- slide -->
<div id="carouselExampleControls" style="z-index: -1;" class="carousel slide carousel-fade mt-5"
     data-bs-ride="carousel"  data-bs-interval="2000">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/static/images/slideshow/slide1.jpg" class="d-block w-100" alt="Los Angeles">
        </div>
        <div class="carousel-item">
            <img src="/static/images/slideshow/slide2.jpg" class="d-block w-100" alt="Los Angeles">
        </div>
        <div class="carousel-item">
            <img src="/static/images/slideshow/slide3.jpg" class="d-block w-100" alt="Los Angeles">
        </div>
        <div class="carousel-item">
            <img src="/static/images/slideshow/slide4.jpg" class="d-block w-100" alt="Los Angeles">
        </div>
    </div>
</div>
