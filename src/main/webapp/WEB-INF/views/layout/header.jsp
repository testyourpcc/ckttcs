...
<header>
    <img src="https://img.tgdd.vn/imgt/f_webp,fit_outside,quality_100/https://cdn.tgdd.vn/2024/02/banner/Big-T3-1200-44-1200x44.png"
         alt="" width="100%">
</header>

<nav id="navbar" class="navbar navbar-expand-sm navbar-dark sticky-top "
     style="background-color: #F8F8FF; border-bottom: 1px solid gainsboro;">
    <div class="container ">
        <div class="row" style="padding: 20px 15px 12px;">
            <div class="col-sm-4" style="margin-top: -10px; padding-left: 30px;">
                <a href="/"><img src="/static/images/logo.png" alt="" width="60%"></a>
            </div>
            <div class="col-sm-4" style="padding-right: 15px;">
                <div class="input-group">
                    <form action="/product/list-by-keywords" method="post">
                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                        <input style="width: 240px" class="form-control" value="${param.keywords}" name="keywords"
            ...
            <div class="col-sm-4" style="padding: 0px 35px;">
                <div class="row">
                                                ...
                                                <li>
                                                    <div class="row">
                                                        <c:choose>
                                                            ...
                                                            <c:otherwise>
                                                                <div style="padding: 10px 10px 10px 30px;">Không có sản
                    ...
                    <div class="col-sm-6">
                        <div class="header-menu">
                            <div class="position-relative">
                                <a class="splike" href="/product/favo" style="color: #474c51"> <i
                                        class="glyphicon glyphicon-heart" style="font-size: 30px"> </i></a>
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">${favor_size}</span>
                            </div>&nbsp;
